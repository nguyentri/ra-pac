...
This is the Peripheral Access Crate (PAC) for the RA2E3 device series.
...
The `ra2e3-pac` crate provides low-level access to device registers, enabling developers to interact with the hardware safely and efficiently.
