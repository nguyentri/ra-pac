...
#[allow(unused_imports)]
use crate::common::*;
#[doc = r"General PWM 16-bit Timer 2"]
...
pub mod gtcr {
    ...
    impl Tpcs {
        ...
        #[doc = "GTETRGA (with the POEG)"]
        pub const _1100: Self = Self::new(12);

        #[doc = "GTETRGB (with the POEG)"]
        pub const _1101: Self = Self::new(13);

        #[doc = "GTETRGC (with the POEG)"]
        pub const _1110: Self = Self::new(14);

        #[doc = "GTETRGD (with the POEG)POEG接続数に応じた、GTETRGA-D表示制御必要。"]
...
pub mod gtintad {
    ...
    impl Grp {
        #[doc = "Group A output disable source is selected"]
        pub const _00: Self = Self::new(0);

        #[doc = "Group B output disable source is selected"]
        pub const _01: Self = Self::new(1);

        #[doc = "Group C output disable source is selected"]
        pub const _10: Self = Self::new(2);

        #[doc = "Group D output disable source is selected"]
        pub const _11: Self = Self::new(3);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
...
pub mod gticlf {
    ...
    impl Iclfa {
        ...
        #[doc = "NOT C (1 PCLKD delay)"]
        pub const _011: Self = Self::new(3);

        #[doc = "A AND C (1 PCLKD delay)"]
        pub const _100: Self = Self::new(4);

        #[doc = "A OR C (1 PCLKD delay)"]
        pub const _101: Self = Self::new(5);

        #[doc = "A EXOR C (1 PCLKD delay)"]
        pub const _110: Self = Self::new(6);

        #[doc = "A NOR C (1 PCLKD delay)"]
        pub const _111: Self = Self::new(7);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Iclfb {
        ...
        #[doc = "NOT D (1 PCLKD delay)"]
        pub const _011: Self = Self::new(3);

        #[doc = "B AND D (1 PCLKD delay)"]
        pub const _100: Self = Self::new(4);

        #[doc = "B OR D (1 PCLKD delay)"]
        pub const _101: Self = Self::new(5);

        #[doc = "B EXOR D (1 PCLKD delay)"]
        pub const _110: Self = Self::new(6);

        #[doc = "B NOR D (1 PCLKD delay)"]
        pub const _111: Self = Self::new(7);
    }
}
#[doc(hidden)]
