...
impl Semr {
    ...
    #[doc = "Asynchronous Mode Extended Base Clock Select1\n(Valid only in asynchronous mode and SCR.CKE\\[1\\]=0)"]
    #[inline(always)]
    pub fn abcse(
        self,
    ) -> crate::common::RegisterField<
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterFieldBool<0, 1, 0, Semr_SPEC, crate::common::RW> {
        crate::common::RegisterFieldBool::<0, 1, 0, Semr_SPEC, crate::common::RW>::from_register(
            self, 0,
        )
    }
}
