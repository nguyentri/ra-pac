...
impl super::Drw {
    ...
    #[doc = "DRW Bufferable Write Enable Register"]
    #[inline(always)]
    pub const fn dbwer(&self) -> &'static crate::common::Reg<self::Dbwer_SPEC, crate::common::RW> {
        unsafe {
            crate::common::Reg::<self::Dbwer_SPEC, crate::common::RW>::from_ptr(
...
#[doc(hidden)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct Dbwer_SPEC;
impl crate::sealed::RegSpec for Dbwer_SPEC {
    type DataType = u32;
}

#[doc = "DRW Bufferable Write Enable Register"]
pub type Dbwer = crate::RegValueT<Dbwer_SPEC>;
...
impl ::core::default::Default for Dbwer {
    #[inline(always)]
    fn default() -> Dbwer {
        <crate::RegValueT<Dbwer_SPEC> as RegisterValue<_>>::new(0)
    }
}
pub mod dbwer {
