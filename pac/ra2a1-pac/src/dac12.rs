...
impl super::Dac12 {
    ...
    pub const fn dapc(&self) -> &'static crate::common::Reg<self::Dapc_SPEC, crate::common::RW> {
        unsafe {
            crate::common::Reg::<self::Dapc_SPEC, crate::common::RW>::from_ptr(
...
impl Daadscr {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<0, 0x7f, 1, 0, u8, u8, Daadscr_SPEC, crate::common::RW> {
        crate::common::RegisterField::<0,0x7f,1,0,u8,u8,Daadscr_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl crate::sealed::RegSpec for Dapc_SPEC {
    type DataType = u8;
}
...
impl Dapc {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<1, 0x7f, 1, 0, u8, u8, Dapc_SPEC, crate::common::RW> {
...
impl ::core::default::Default for Dapc {
    #[inline(always)]
    fn default() -> Dapc {
        <crate::RegValueT<Dapc_SPEC> as RegisterValue<_>>::new(0)
    }
}
pub mod dapc {
