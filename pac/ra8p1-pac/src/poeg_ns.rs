...
unsafe impl ::core::marker::Send for super::PoegNs {}
unsafe impl ::core::marker::Sync for super::PoegNs {}
impl super::PoegNs {
    #[allow(unused)]
    #[inline(always)]
...
pub mod poegga {
    ...
    impl Cdre2 {
        #[doc = "Disable output-disable request from ACMPHS2"]
        pub const _0: Self = Self::new(0);

        #[doc = "Enable output-disable request from ACMPHS2"]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Cdre3 {
        #[doc = "Disable output-disable request from ACMPHS3"]
        pub const _0: Self = Self::new(0);

        #[doc = "Enable output-disable request from ACMPHS3"]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct St_SPEC;
