...
#[allow(unused_imports)]
use crate::common::*;
#[doc = r"DMAC Module Contorol"]
unsafe impl ::core::marker::Send for super::Dma0 {}
unsafe impl ::core::marker::Sync for super::Dma0 {}
impl super::Dma0 {
    #[allow(unused)]
    #[inline(always)]
    ...
    #[inline(always)]
    pub const fn dmctl(&self) -> &'static crate::common::Reg<self::Dmctl_SPEC, crate::common::RW> {
        unsafe {
            crate::common::Reg::<self::Dmctl_SPEC, crate::common::RW>::from_ptr(
...
impl crate::sealed::RegSpec for Dmctl_SPEC {
    type DataType = u8;
}

#[doc = "DMAC Control Register"]
pub type Dmctl = crate::RegValueT<Dmctl_SPEC>;

impl Dmctl {
    #[doc = "Priority Control Select"]
    #[inline(always)]
    pub fn pr(
        self,
    ) -> crate::common::RegisterField<
...
impl ::core::default::Default for Dmctl {
    #[inline(always)]
    fn default() -> Dmctl {
        <crate::RegValueT<Dmctl_SPEC> as RegisterValue<_>>::new(0)
    }
}
pub mod dmctl {
    ...
    impl Pr {
        #[doc = "Fixed priority mode"]
        pub const _0: Self = Self::new(0);

        #[doc = "Round-robin mode"]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Erch_SPEC;
    pub type Erch = crate::EnumBitfieldStruct<u8, Erch_SPEC>;
    impl Erch {
        #[doc = "Target channel only"]
        pub const _0: Self = Self::new(0);
...
impl Dmechr {
    ...
    pub fn dmech(
        self,
    ) -> crate::common::RegisterField<0, 0xf, 1, 0, u8, u8, Dmechr_SPEC, crate::common::R> {
        crate::common::RegisterField::<0,0xf,1,0,u8,u8,Dmechr_SPEC,crate::common::R>::from_register(self,0)
    }
