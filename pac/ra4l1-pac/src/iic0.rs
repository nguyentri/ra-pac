...
impl super::Iic0 {
    ...
    #[inline(always)]
    pub const fn icdrr(&self) -> &'static crate::common::Reg<self::Icdrr_SPEC, crate::common::RW> {
        unsafe {
            crate::common::Reg::<self::Icdrr_SPEC, crate::common::RW>::from_ptr(
...
pub mod iccr1 {
    ...
    impl Sdai {
        #[doc = "SDA0 line is low"]
        pub const _0: Self = Self::new(0);

        #[doc = "SDA0 line is high"]
    ...
    impl Scli {
        #[doc = "SCL0 line is low"]
        pub const _0: Self = Self::new(0);

        #[doc = "SCL0 line is high"]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Sdao {
        #[doc = "Read: IIC drives SDA0 pin low Write: IIC drives SDA0 pin low"]
        pub const _0: Self = Self::new(0);

        #[doc = "Read: IIC releases SDA0 pin Write: IIC releases SDA0 pin"]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Sclo {
        #[doc = "Read: IIC drives SCL0 pin low Write: IIC drives SCL0 pin low"]
        pub const _0: Self = Self::new(0);

        #[doc = "Read: IIC releases SCL0 pin Write: IIC releases SCL0 pin"]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Ice {
        #[doc = "Disable (SCL0 and SDA0 pins in inactive state)"]
        pub const _0: Self = Self::new(0);

        #[doc = "Enable (SCL0 and SDA0 pins in active state)"]
        pub const _1: Self = Self::new(1);
    }
}
#[doc(hidden)]
...
pub mod icmr2 {
    ...
    impl Tmol {
        #[doc = "Disable count while SCL0 line is low"]
        pub const _0: Self = Self::new(0);

        #[doc = "Enable count while SCL0 line is low"]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Tmoh {
        #[doc = "Disable count while SCL0 line is high"]
        pub const _0: Self = Self::new(0);

        #[doc = "Enable count while SCL0 line is high"]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Sddl {
        ...
        #[doc = "1 cycle (When ICMR2.DLCS = 0 (IIC)) 1 or 2 cycles (When ICMR2.DLCS = 1 (/2))"]
        pub const _001: Self = Self::new(1);

        #[doc = "2 cycles (When ICMR2.DLCS = 0 ()) 3 or 4 cycles (When ICMR2.DLCS = 1 (/2))"]
        pub const _010: Self = Self::new(2);

        #[doc = "3 cycles (When ICMR2.DLCS = 0 ()) 5 or 6 cycles (When ICMR2.DLCS = 1 (/2))"]
        pub const _011: Self = Self::new(3);

        #[doc = "4 cycles (When ICMR2.DLCS = 0 ()) 7 or 8 cycles (When ICMR2.DLCS = 1 (/2))"]
        pub const _100: Self = Self::new(4);

        #[doc = "5 cycles (When ICMR2.DLCS = 0 ()) 9 or 10 cycles (When ICMR2.DLCS = 1 (/2))"]
        pub const _101: Self = Self::new(5);

        #[doc = "6 cycles (When ICMR2.DLCS = 0 ()) 11 or 12 cycles (When ICMR2.DLCS = 1 (/2))"]
        pub const _110: Self = Self::new(6);

        #[doc = "7 cycles (When ICMR2.DLCS = 0 ()) 13 or 14 cycles (When ICMR2.DLCS = 1 (/2))"]
        pub const _111: Self = Self::new(7);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Dlcs {
        #[doc = "Select internal reference clock () as the clock source for SDA output delay counter"]
        pub const _0: Self = Self::new(0);

        #[doc = "Select internal reference clock divided by 2 (/2) as the clock source for SDA output delay counter"]
        pub const _1: Self = Self::new(1);
    }
}
#[doc(hidden)]
...
pub mod icmr3 {
    ...
    impl Nf {
        #[doc = "Filter out noise of up to 1 cycle (single-stage filter)"]
        pub const _00: Self = Self::new(0);

        #[doc = "Filter out noise of up to 2 cycles (2-stage filter)"]
        pub const _01: Self = Self::new(1);

        #[doc = "Filter out noise of up to 3 cycles (3-stage filter)"]
        pub const _10: Self = Self::new(2);

        #[doc = "Filter out noise of up to 4 cycles (4-stage filter)"]
    ...
    impl Rdrfs {
        #[doc = "Set the RDRF flag on the rising edge of the 9th SCL clock cycle. The SCL0 line is not held low on the falling edge of the 8th clock cycle."]
        pub const _0: Self = Self::new(0);

        #[doc = "Set the RDRF flag on the rising edge of the 8th SCL clock cycle. The SCL0 line is held low on the falling edge of the 8th clock cycle."]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Wait {
        #[doc = "No wait (the SCL0 line is not held low during the period between the 9th clock cycle and the 1st clock cycle.)"]
        pub const _0: Self = Self::new(0);

        #[doc = "Wait (the SCL0 line is held low during the period between the 9th clock cycle and the 1st clock cycle.)"]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
...
pub mod icfer {
    ...
    impl Fmpe {
        #[doc = "Do not use the Fm+ slope control circuit for the SCL0 and SDA0 pins"]
        pub const _0: Self = Self::new(0);

        #[doc = "Use the Fm+ slope control circuit for the SCL0 and SDA0 pins."]
        pub const _1: Self = Self::new(1);
    }
}
#[doc(hidden)]
...
pub mod icier {
    ...
    impl Rie {
        #[doc = "Disable receive data full interrupt (IIC0_RXI) request"]
        pub const _0: Self = Self::new(0);

        #[doc = "Enable receive data full interrupt (IIC0_RXI) request"]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Teie {
        #[doc = "Disable transmit end interrupt (IIC0_TEI) request"]
        pub const _0: Self = Self::new(0);

        #[doc = "Enable transmit end interrupt (IIC0_TEI) request"]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Tie_SPEC;
    ...
    impl Tie {
        #[doc = "Disable transmit data empty interrupt (IIC0_TXI) request"]
        pub const _0: Self = Self::new(0);

        #[doc = "Enable transmit data empty interrupt (IIC0_TXI) request"]
        pub const _1: Self = Self::new(1);
    }
}
#[doc(hidden)]
