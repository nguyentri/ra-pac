...
unsafe impl ::core::marker::Send for super::I3CNs {}
unsafe impl ::core::marker::Sync for super::I3CNs {}
impl super::I3CNs {
    #[allow(unused)]
    #[inline(always)]
    ...
    #[doc = "Clock Enable Control Register"]
    #[inline(always)]
    ...
    #[doc = "Asynchronous Timing Control Counter Enable Register"]
    #[inline(always)]
...
pub mod rstctl {
    ...
    impl Htdbrst {
        #[doc = "The High Priority Tx Data buffers in I3C is not flushed."]
        pub const _0: Self = Self::new(0);

        #[doc = "The High Priority Tx Data buffers in I3C is flushed."]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Hrdbrst {
        #[doc = "The High Priority Rx Data buffers in I3C is not flushed."]
        pub const _0: Self = Self::new(0);

        #[doc = "The High Priority Rx Data buffers in I3C is flushed."]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
...
pub mod htst {
    ...
    impl Tdbef {
        #[doc = "The number of empties in the High Priority Tx Data Buffer is less than the HTBTHCTL.TXDBTH\\[2:0\\] threshold."]
        pub const _0: Self = Self::new(0);

        #[doc = "The number of empties in the High Priority Tx Data Buffer is or more than the HTBTHCTL.TXDBTH\\[2:0\\] threshold."]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Rdbff {
        #[doc = "The number of entries in the High Priority Rx Data Buffer is less than the HTBTHCTL.RXDBTH\\[2:0\\] threshold."]
        pub const _0: Self = Self::new(0);

        #[doc = "The number of entries in the High Priority Rx Data Buffer is or more than the HTBTHCTL.RXDBTH\\[2:0\\] threshold."]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Cmdqef_SPEC;
    pub type Cmdqef = crate::EnumBitfieldStruct<u8, Cmdqef_SPEC>;
    impl Cmdqef {
        #[doc = "If HQTHCTL.CMDQTH is 0, the number of High Priority Command Queue empties is less than the Command Queue size. If HQTHCTL.CMDQTH is other than 0, the number of High Priority Command Queue empties is less than the HQTHCTL.CMDQTH threshold."]
        pub const _0: Self = Self::new(0);

        #[doc = "If HQTHCTL.CMDQTH is 0, the number of High Priority Command Queue empties is the Command Queue size. If HQTHCTL.CMDQTH is other than 0, the number of High Priority Command Queue empties is or more than the HQTHCTL.CMDQTH threshold ."]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Rspqff_SPEC;
    ...
    impl Rspqff {
        ...
        #[doc = "The number of High Priority Response Queue entries is or more than the HQTHCTL .RSPQTH threshold."]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Tabtf_SPEC;
...
pub mod htste {
    ...
    pub type Cmdqee = crate::EnumBitfieldStruct<u8, Cmdqee_SPEC>;
    impl Cmdqee {
        #[doc = "Disables High Priority Command Queue Empty Interrupt Status logging."]
        pub const _0: Self = Self::new(0);

        #[doc = "Enables High Priority Command Queue Empty Interrupt Status logging."]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Rspqfe_SPEC;
    pub type Rspqfe = crate::EnumBitfieldStruct<u8, Rspqfe_SPEC>;
    impl Rspqfe {
        #[doc = "Disables High Priority Response Queue Full Interrupt Status logging."]
        pub const _0: Self = Self::new(0);

        #[doc = "Enables High Priority Response Queue Full Interrupt Status logging."]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Tabte_SPEC;
    pub type Tabte = crate::EnumBitfieldStruct<u8, Tabte_SPEC>;
    impl Tabte {
        #[doc = "Disables High Priority Transfer Abort Interrupt Status logging."]
        pub const _0: Self = Self::new(0);
...
pub mod htie {
    ...
    pub type Cmdqeie = crate::EnumBitfieldStruct<u8, Cmdqeie_SPEC>;
    impl Cmdqeie {
        #[doc = "Disables High Priority Command Queue Empty Interrupt Signal."]
        pub const _0: Self = Self::new(0);

        #[doc = "Enables High Priority Command Queue Empty Interrupt Signal."]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Rspqfie_SPEC;
    pub type Rspqfie = crate::EnumBitfieldStruct<u8, Rspqfie_SPEC>;
    impl Rspqfie {
        #[doc = "Disables High Priority Response Queue Full Interrupt Signal."]
        pub const _0: Self = Self::new(0);

        #[doc = "Enables High Priority Response Queue Full Interrupt Signal."]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Tabtie_SPEC;
...
pub mod htstfc {
    ...
    impl Tdbefc {
        ...
        #[doc = "Force High Priority Tx Data Buffer Empty Interrupt for software testing."]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    pub type Cmdqefc = crate::EnumBitfieldStruct<u8, Cmdqefc_SPEC>;
    impl Cmdqefc {
        #[doc = "Not Force High Priority Command Queue Empty Interrupt for software testing."]
        pub const _0: Self = Self::new(0);

        #[doc = "Force High Priority Command Queue Empty Interrupt for software testing."]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Rspqffc_SPEC;
    pub type Rspqffc = crate::EnumBitfieldStruct<u8, Rspqffc_SPEC>;
    impl Rspqffc {
        #[doc = "Not Force High Priority Response Queue Full Interrupt for software testing."]
        pub const _0: Self = Self::new(0);

        #[doc = "Force High Priority Response Queue Full Interrupt for software testing."]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Tabtfc_SPEC;
...
impl Sdatbas {
    ...
    pub fn sddyad(
        self,
    ) -> crate::common::RegisterField<16, 0x7f, 1, 0, u8, u8, Sdatbas_SPEC, crate::common::RW> {
        crate::common::RegisterField::<16,0x7f,1,0,u8,u8,Sdatbas_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl Hdbstlv {
    #[doc = "High Priority Tx Data Buffer Free Level"]
    #[inline(always)]
    pub fn tdbflv(
        self,
    ...
    #[doc = "High Priority Rx Data Buffer Level"]
    #[inline(always)]
    pub fn rdblv(
        self,
