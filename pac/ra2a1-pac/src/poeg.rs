...
impl Poegg {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<9, 0x7, 1, 0, u8, u8, Poegg_SPEC, crate::common::RW> {
        crate::common::RegisterField::<9,0x7,1,0,u8,u8,Poegg_SPEC,crate::common::RW>::from_register(self,0)
    }
