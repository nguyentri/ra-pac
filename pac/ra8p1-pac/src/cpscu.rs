...
impl super::Cpscu {
    ...
    #[doc = "TCM Security Attribution Register"]
    #[inline(always)]
    pub const fn tcmsar(
        &self,
    ) -> &'static crate::common::Reg<self::Tcmsar_SPEC, crate::common::RW> {
        unsafe {
            crate::common::Reg::<self::Tcmsar_SPEC, crate::common::RW>::from_ptr(
                self._svd2pac_as_ptr().add(1284usize),
            )
        }
    }

    #[doc = "TCM Security Attribute Boundary Address Register"]
    #[inline(always)]
    pub const fn tcmsabarc(
        &self,
    ) -> &'static crate::common::Reg<self::Tcmsabarc_SPEC, crate::common::RW> {
        unsafe {
            crate::common::Reg::<self::Tcmsabarc_SPEC, crate::common::RW>::from_ptr(
    ...
    #[doc = "TCM Security Attribute Boundary Address Register"]
    #[inline(always)]
    pub const fn tcmsabars(
        &self,
    ) -> &'static crate::common::Reg<self::Tcmsabars_SPEC, crate::common::RW> {
        unsafe {
            crate::common::Reg::<self::Tcmsabars_SPEC, crate::common::RW>::from_ptr(
                self._svd2pac_as_ptr().add(1288usize),
            )
        }
    }
...
impl Debugsar {
    #[doc = "Debug Security Attribution 0"]
    #[inline(always)]
    pub fn dbgsa0(
        self,
    ) -> crate::common::RegisterField<
...
#[doc(hidden)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct Tcmsar_SPEC;
impl crate::sealed::RegSpec for Tcmsar_SPEC {
    type DataType = u32;
}

#[doc = "TCM Security Attribution Register"]
pub type Tcmsar = crate::RegValueT<Tcmsar_SPEC>;

impl Tcmsar {
    #[doc = "Security attributes of registers for TCM control"]
    #[inline(always)]
    pub fn tcmsa(
        self,
    ) -> crate::common::RegisterField<
...
impl ::core::default::Default for Tcmsar {
    #[inline(always)]
    fn default() -> Tcmsar {
        <crate::RegValueT<Tcmsar_SPEC> as RegisterValue<_>>::new(0)
    }
}
pub mod tcmsar {

    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Tcmsa_SPEC;
    pub type Tcmsa = crate::EnumBitfieldStruct<u8, Tcmsa_SPEC>;
    impl Tcmsa {
        #[doc = "Secure"]
        pub const _0: Self = Self::new(0);
...
#[doc(hidden)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct Tcmsabarc_SPEC;
impl crate::sealed::RegSpec for Tcmsabarc_SPEC {
    type DataType = u32;
}

#[doc = "TCM Security Attribute Boundary Address Register"]
pub type Tcmsabarc = crate::RegValueT<Tcmsabarc_SPEC>;

impl Tcmsabarc {
    #[doc = "Boundary address between secure and non-secure (start address of non-secure region)."]
    #[inline(always)]
    pub fn tcmsaba(
        self,
    ) -> crate::common::RegisterField<13, 0x3f, 1, 0, u8, u8, Tcmsabarc_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<13,0x3f,1,0,u8,u8,Tcmsabarc_SPEC,crate::common::RW>::from_register(self,0)
    }
}
impl ::core::default::Default for Tcmsabarc {
    #[inline(always)]
    fn default() -> Tcmsabarc {
        <crate::RegValueT<Tcmsabarc_SPEC> as RegisterValue<_>>::new(516096)
    }
}

#[doc(hidden)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct Tcmsabars_SPEC;
impl crate::sealed::RegSpec for Tcmsabars_SPEC {
    type DataType = u32;
}

#[doc = "TCM Security Attribute Boundary Address Register"]
pub type Tcmsabars = crate::RegValueT<Tcmsabars_SPEC>;
...
impl Tcmsabars {
    ...
    pub fn tcmsaba(
        self,
    ) -> crate::common::RegisterField<13, 0x3f, 1, 0, u8, u8, Tcmsabars_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<13,0x3f,1,0,u8,u8,Tcmsabars_SPEC,crate::common::RW>::from_register(self,0)
    }
}
impl ::core::default::Default for Tcmsabars {
    #[inline(always)]
    fn default() -> Tcmsabars {
        <crate::RegValueT<Tcmsabars_SPEC> as RegisterValue<_>>::new(516096)
    }
}
