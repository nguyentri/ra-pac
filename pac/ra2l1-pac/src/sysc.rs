...
impl super::Sysc {
    ...
    #[inline(always)]
    pub const fn dcdcctl(
        &self,
    ) -> &'static crate::common::Reg<self::Dcdcctl_SPEC, crate::common::RW> {
        unsafe {
            crate::common::Reg::<self::Dcdcctl_SPEC, crate::common::RW>::from_ptr(
    ...
    pub const fn vccsel(
        &self,
    ) -> &'static crate::common::Reg<self::Vccsel_SPEC, crate::common::RW> {
        unsafe {
            crate::common::Reg::<self::Vccsel_SPEC, crate::common::RW>::from_ptr(
                self._svd2pac_as_ptr().add(1089usize),
            )
        }
    }
...
impl crate::sealed::RegSpec for Dcdcctl_SPEC {
    type DataType = u8;
}

#[doc = "DCDC/LDO Control Register"]
pub type Dcdcctl = crate::RegValueT<Dcdcctl_SPEC>;
...
impl ::core::default::Default for Dcdcctl {
    #[inline(always)]
    fn default() -> Dcdcctl {
        <crate::RegValueT<Dcdcctl_SPEC> as RegisterValue<_>>::new(192)
    }
}
pub mod dcdcctl {

    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Dcdcon_SPEC;
    pub type Dcdcon = crate::EnumBitfieldStruct<u8, Dcdcon_SPEC>;
    impl Dcdcon {
    ...
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Ocpen_SPEC;
    pub type Ocpen = crate::EnumBitfieldStruct<u8, Ocpen_SPEC>;
    impl Ocpen {
    ...
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Stopza_SPEC;
    pub type Stopza = crate::EnumBitfieldStruct<u8, Stopza_SPEC>;
    impl Stopza {
    ...
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Lcboost_SPEC;
    pub type Lcboost = crate::EnumBitfieldStruct<u8, Lcboost_SPEC>;
    impl Lcboost {
    ...
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Fst_SPEC;
    pub type Fst = crate::EnumBitfieldStruct<u8, Fst_SPEC>;
    impl Fst {
    ...
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Pd_SPEC;
    pub type Pd = crate::EnumBitfieldStruct<u8, Pd_SPEC>;
    impl Pd {
...
impl crate::sealed::RegSpec for Vccsel_SPEC {
    type DataType = u8;
}

#[doc = "Voltage Level Selection Control Register"]
pub type Vccsel = crate::RegValueT<Vccsel_SPEC>;
...
impl ::core::default::Default for Vccsel {
    #[inline(always)]
    fn default() -> Vccsel {
        <crate::RegValueT<Vccsel_SPEC> as RegisterValue<_>>::new(0)
    }
}
pub mod vccsel {
    ...
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Vccsel_SPEC;
    pub type Vccsel = crate::EnumBitfieldStruct<u8, Vccsel_SPEC>;
    impl Vccsel {
        #[doc = "2.7 V =< VCC < 3.6 V"]
        pub const _00: Self = Self::new(0);
