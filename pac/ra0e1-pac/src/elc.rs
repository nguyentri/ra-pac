...
pub mod elcr {
    ...
    impl Elcon {
        #[doc = "All the event link operations are disabled."]
        pub const _0: Self = Self::new(0);

        #[doc = "All the event link operations are enabled."]
...
pub mod elsegr {
    ...
    impl Seg {
        #[doc = "Not generate a software event."]
        pub const _0: Self = Self::new(0);
...
impl Elsr {
    ...
    pub fn els(
        self,
    ) -> crate::common::RegisterField<0, 0x3f, 1, 0, u8, u8, Elsr_SPEC, crate::common::RW> {
        crate::common::RegisterField::<0,0x3f,1,0,u8,u8,Elsr_SPEC,crate::common::RW>::from_register(self,0)
    }
}
