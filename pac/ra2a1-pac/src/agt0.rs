...
pub mod agtmr1 {
    ...
    impl Tck {
        ...
        #[doc = "Divided clock LOCO specified by bits CKS\\[2:0\\] in the AGTMR2 register"]
        pub const _100: Self = Self::new(4);

        #[doc = "Underflow event signal from AGT0"]
        pub const _101: Self = Self::new(5);

        #[doc = "Divided clock fSUB specified by bits CKS\\[2:0\\] in the AGTMR2 register"]
...
impl Agtiosel {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<0, 0xf, 1, 0, u8, u8, Agtiosel_SPEC, crate::common::RW> {
        crate::common::RegisterField::<0,0xf,1,0,u8,u8,Agtiosel_SPEC,crate::common::RW>::from_register(self,0)
    }
}
