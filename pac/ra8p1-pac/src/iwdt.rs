...
impl ::core::default::Default for Iwdtcstpr {
    ...
    fn default() -> Iwdtcstpr {
        <crate::RegValueT<Iwdtcstpr_SPEC> as RegisterValue<_>>::new(128)
    }
}
pub mod iwdtcstpr {
    ...
    impl Slcstp {
        ...
        #[doc = "Stop the counter when the primary CPU enters CPU Sleep mode or CPU Deep Sleep mode, and when the MCU enters Software Standby mode or Deep Software Standby mode 1."]
        pub const _1: Self = Self::new(1);
    }
}
