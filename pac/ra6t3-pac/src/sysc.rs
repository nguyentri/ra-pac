...
pub mod canfdckdivcr {
    ...
    impl Canfdckdiv {
        #[doc = "/1 (value after reset) /2 /4 /6 /8 /3 /5"]
        pub const _000: Self = Self::new(0);
    }
}
#[doc(hidden)]
...
impl Snzreqcr0 {
    ...
    #[doc = "Enable ACMPHS0 alarm snooze request"]
    #[inline(always)]
    pub fn snzreqen22(
        self,
    ) -> crate::common::RegisterField<
...
pub mod dpsbycr {
    ...
    impl Deepcut {
        #[doc = "Power to the Low-speed on-chip oscillator, AGTn (n = 0, 1), and USBFS resume detecting unit is supplied in Deep Software Standby mode."]
        pub const _00: Self = Self::new(0);

        #[doc = "Power to the Low-speed on-chip oscillator, AGT, and USBFS resume detecting unit is not supplied in Deep Software Standby mode."]
        pub const _01: Self = Self::new(1);

        #[doc = "Setting prohibited"]
        pub const _10: Self = Self::new(2);

        #[doc = "Power to the Low-speed on-chip oscillator, AGT, and USBFS resume detecting unit is not supplied in Deep Software Standby mode. In addition, LVD is disabled and the low power function in a power-on reset circuit is enabled."]
        pub const _11: Self = Self::new(3);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
