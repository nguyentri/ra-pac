...
pub mod sptr {
    ...
    impl Rxdmon {
        #[doc = "When RINV = 0, RXDn terminal is the low level. When RINV = 1, RXDn terminal is the high level."]
        pub const _0: Self = Self::new(0);

        #[doc = "When RINV = 0, RXDn terminal is the high level. When RINV = 1, RXDn terminal is the low level."]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Spb2Dt {
        #[doc = "When TINV = 0, low level is output in TXDn terminal. When TINV = 1, high level is output in TXDn terminal."]
        pub const _0: Self = Self::new(0);

        #[doc = "When TINV = 0, high level is output in TXDn terminal. When TINV = 1, low level is output in TXDn terminal."]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
...
pub mod ircr {
    ...
    impl Irrxinv {
        #[doc = "Use input from IRRXD pin as received data as is"]
        pub const _0: Self = Self::new(0);

        #[doc = "Use input from IRRXD pin as received data after the polarity is inverted"]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Irtxinv {
        #[doc = "Output transmitted data to IRTXD pin as is"]
        pub const _0: Self = Self::new(0);

        #[doc = "Output transmitted data to IRTXD pin after the polarity is inverted"]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Ire_SPEC;
    ...
    impl Ire {
        #[doc = "Use serial input/output pins for normal serial communication"]
        pub const _0: Self = Self::new(0);

        #[doc = "Use serial input/output pins for IrDA data communication"]
        pub const _1: Self = Self::new(1);
    }
}
