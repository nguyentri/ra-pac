...
#[allow(unused_imports)]
use crate::common::*;
#[doc = r"Data Transfer Controller for Non-secure"]
unsafe impl ::core::marker::Send for super::Dtc0Ns {}
unsafe impl ::core::marker::Sync for super::Dtc0Ns {}
impl super::Dtc0Ns {
    #[allow(unused)]
    #[inline(always)]
    ...
    #[doc = "DTC Address Displacement Register"]
    #[inline(always)]
    pub const fn dtcdisp(
        &self,
    ) -> &'static crate::common::Reg<self::Dtcdisp_SPEC, crate::common::RW> {
        unsafe {
            crate::common::Reg::<self::Dtcdisp_SPEC, crate::common::RW>::from_ptr(
...
impl Dtccr {
    #[doc = "DTC Transfer Information Read Skip Enable for Non-secure"]
    #[inline(always)]
    pub fn rrs(
        self,
...
#[doc(hidden)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct Dtcdisp_SPEC;
impl crate::sealed::RegSpec for Dtcdisp_SPEC {
    type DataType = u32;
}

#[doc = "DTC Address Displacement Register"]
pub type Dtcdisp = crate::RegValueT<Dtcdisp_SPEC>;

impl Dtcdisp {
    #[doc = "DTC Address Displacement"]
    #[inline(always)]
    pub fn dtcdisp(
        self,
    ) -> crate::common::RegisterField<0, 0xffffffff, 1, 0, u32, u32, Dtcdisp_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0xffffffff,1,0,u32,u32,Dtcdisp_SPEC,crate::common::RW>::from_register(self,0)
    }
}
impl ::core::default::Default for Dtcdisp {
    #[inline(always)]
    fn default() -> Dtcdisp {
        <crate::RegValueT<Dtcdisp_SPEC> as RegisterValue<_>>::new(0)
    }
}
