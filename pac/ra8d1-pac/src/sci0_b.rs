...
unsafe impl ::core::marker::Send for super::Sci0B {}
unsafe impl ::core::marker::Sync for super::Sci0B {}
impl super::Sci0B {
    #[allow(unused)]
    #[inline(always)]
...
impl Ccr4 {
    ...
    #[doc = "Master receive clock selection"]
    #[inline(always)]
    pub fn scksel(
        self,
    ) -> crate::common::RegisterField<
...
pub mod ccr4 {
    ...
    impl Scksel {
        #[doc = "Master receive clock is disabled"]
        pub const _0: Self = Self::new(0);

        #[doc = "Master receive clock is enabled"]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Ast_SPEC;
