...
impl Syssts0 {
    #[doc = "External USB0_OVRCURA/ USB0_OVRCURB Input Pin Monitor\nThe OCVMON\\[1\\] bit indicates the status of the USBHS_OVRCURA pin. \nThe OCVMON\\[0\\] bit indicates the status of the USBHS_OVRCURB pin."]
    #[inline(always)]
    pub fn ovcmon(
        self,
...
impl Dvstctr0 {
    #[doc = "Host Negotiation Protocol (HNP) Control     \nThis bit is used when switching from device B to device A while in OTG mode. If the HNPBTOA bit is 1, the internal function control keeps the suspended state until the HNP processing ends even  though SYSCFG.DPRPU = 0 or SYSCFG.DCFM = 1 is set."]
    #[inline(always)]
    pub fn hnpbtoa(
        self,
    ) -> crate::common::RegisterField<
...
impl Usbval {
    #[doc = "Value\nThese bits store the USB request Value value."]
    #[inline(always)]
    pub fn wvalue(
        self,
...
impl Dcpmaxp {
    ...
    #[doc = "Maximum Packet Size\nThese bits set the maximum amount of data (maximum packet size) in payloads for the DCP."]
    #[inline(always)]
    pub fn mxps(
        self,
    ) -> crate::common::RegisterField<
...
impl Pipemaxp {
    ...
    #[doc = "Maximum Packet Size\nPIPE1 and PIPE2:  1 byte (001h) to 256 bytes (100h)\nPIPE3 to PIPE5:   8 bytes (008h), 16 bytes (010h),  32 bytes (020h), 64 bytes (040h)   (Bits \\[8:7\\] and \\[2:0\\] are not provided.)\nPIPE6 to PIPE9:  1 byte (001h) to 64 bytes (040h)  (Bits \\[8:7\\] are not provided.)"]
    #[inline(always)]
    pub fn mxps(
        self,
...
impl Pipeperi {
    ...
    #[doc = "Interval Error Detection Interval\nSpecifies the interval error detection timing for the selected pipe in terms of frames, which is expressed as nth power of 2."]
    #[inline(always)]
    pub fn iitv(
        self,
