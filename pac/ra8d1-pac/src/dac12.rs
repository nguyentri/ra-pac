...
impl Daampcr {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<0, 0x3f, 1, 0, u8, u8, Daampcr_SPEC, crate::common::RW> {
...
impl Daaswcr {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<0, 0x3f, 1, 0, u8, u8, Daaswcr_SPEC, crate::common::RW> {
...
impl Daadusr {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<2, 0x3f, 1, 0, u8, u8, Daadusr_SPEC, crate::common::RW> {
        crate::common::RegisterField::<2,0x3f,1,0,u8,u8,Daadusr_SPEC,crate::common::RW>::from_register(self,0)
    }
}
