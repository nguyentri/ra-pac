...
impl Syssts0 {
    ...
    #[doc = "External USB_OVRCURA Input Pin Monitor"]
    #[inline(always)]
    pub fn ovcmon(
        self,
    ) -> crate::common::RegisterFieldBool<15, 1, 0, Syssts0_SPEC, crate::common::R> {
        crate::common::RegisterFieldBool::<15, 1, 0, Syssts0_SPEC, crate::common::R>::from_register(
            self, 0,
        )
    }
}
