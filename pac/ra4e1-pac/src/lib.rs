...
#![doc = "Arm Cortex-M33 based Microcontroller RA4E1 group"]
pub mod common;
pub use common::*;
...
#[cfg(feature = "gpt321")]
pub const GPT321: self::Gpt321 = self::Gpt321 {
    ptr: 0x40169100u32 as _,
};
#[cfg(feature = "gpt322")]
pub const GPT322: self::Gpt321 = self::Gpt321 {
...
pub struct Peripherals {
    ...
    pub SPI0: self::Spi0,
    #[cfg(feature = "gpt321")]
    pub GPT321: self::Gpt321,
    #[cfg(feature = "gpt322")]
    pub GPT322: self::Gpt321,
    #[cfg(feature = "gpt164")]
