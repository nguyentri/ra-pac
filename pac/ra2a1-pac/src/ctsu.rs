...
impl Ctsumch1 {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<6, 0x3, 1, 0, u8, u8, Ctsumch1_SPEC, crate::common::R> {
        crate::common::RegisterField::<6,0x3,1,0,u8,u8,Ctsumch1_SPEC,crate::common::R>::from_register(self,0)
    }
...
pub mod ctsuchtrc2 {
    ...
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Ctsuchrc2_SPEC;
    pub type Ctsuchrc2 = crate::EnumBitfieldStruct<u8, Ctsuchrc2_SPEC>;
    impl Ctsuchrc2 {
        #[doc = "Reception"]
        pub const _0: Self = Self::new(0);
...
pub mod ctsuchtrc3 {
    ...
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Ctsuchrc3_SPEC;
    pub type Ctsuchrc3 = crate::EnumBitfieldStruct<u8, Ctsuchrc3_SPEC>;
    impl Ctsuchrc3 {
        #[doc = "Reception"]
        pub const _0: Self = Self::new(0);
