...
impl Wupen0 {
    ...
    #[doc = "USBHS Interrupt Software Standby/Snooze Mode Returns Enable bit"]
    #[inline(always)]
    pub fn usbhswupen(
        self,
    ) -> crate::common::RegisterField<
...
pub mod wupen0 {
    ...
    impl Usbhswupen {
        #[doc = "Software Standby/Snooze Mode returns by USBHS interrupt is disabled"]
        pub const _0: Self = Self::new(0);

        #[doc = "Software Standby/Snooze Mode returns by USBHS interrupt is enabled"]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
