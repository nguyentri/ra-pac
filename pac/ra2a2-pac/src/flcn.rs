...
impl super::Flcn {
    ...
    pub const fn fctlfr(
        &self,
    ) -> &'static crate::common::Reg<self::Fctlfr_SPEC, crate::common::RW> {
        unsafe {
            crate::common::Reg::<self::Fctlfr_SPEC, crate::common::RW>::from_ptr(
    ...
    #[inline(always)]
    pub const fn fbkpgcr(
        &self,
    ) -> &'static crate::common::Reg<self::Fbkpgcr_SPEC, crate::common::RW> {
        unsafe {
            crate::common::Reg::<self::Fbkpgcr_SPEC, crate::common::RW>::from_ptr(
                self._svd2pac_as_ptr().add(16336usize),
            )
        }
    }
    ...
    #[inline(always)]
    pub const fn fbkswcr(
        &self,
    ) -> &'static crate::common::Reg<self::Fbkswcr_SPEC, crate::common::RW> {
        unsafe {
            crate::common::Reg::<self::Fbkswcr_SPEC, crate::common::RW>::from_ptr(
                self._svd2pac_as_ptr().add(16340usize),
            )
        }
    }
}
...
pub mod fexcr {
    ...
    pub type Cmd = crate::EnumBitfieldStruct<u8, Cmd_SPEC>;
    impl Cmd {
        #[doc = "Flash control flag setting"]
...
#[doc(hidden)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct Fctlfr_SPEC;
impl crate::sealed::RegSpec for Fctlfr_SPEC {
    type DataType = u32;
}

#[doc = "Flash Control Flag Register"]
pub type Fctlfr = crate::RegValueT<Fctlfr_SPEC>;
...
impl ::core::default::Default for Fctlfr {
    #[inline(always)]
    fn default() -> Fctlfr {
        <crate::RegValueT<Fctlfr_SPEC> as RegisterValue<_>>::new(0)
    }
}
pub mod fctlfr {

    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Bankswp_SPEC;
    pub type Bankswp = crate::EnumBitfieldStruct<u8, Bankswp_SPEC>;
    impl Bankswp {
        #[doc = "Bank 1 is the startup bank"]
        pub const _0: Self = Self::new(0);

        #[doc = "Bank 0 is the startup bank"]
        pub const _1: Self = Self::new(1);
    }
}
#[doc(hidden)]
...
#[doc(hidden)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct Fbkpgcr_SPEC;
impl crate::sealed::RegSpec for Fbkpgcr_SPEC {
    type DataType = u16;
}

#[doc = "Flash Bank Program Control Register"]
pub type Fbkpgcr = crate::RegValueT<Fbkpgcr_SPEC>;
...
impl Fbkpgcr {
    ...
    pub fn fekey(
        self,
    ) -> crate::common::RegisterField<8, 0xff, 1, 0, u8, u8, Fbkpgcr_SPEC, crate::common::W> {
        crate::common::RegisterField::<8,0xff,1,0,u8,u8,Fbkpgcr_SPEC,crate::common::W>::from_register(self,0)
    }
}
impl ::core::default::Default for Fbkpgcr {
    #[inline(always)]
    fn default() -> Fbkpgcr {
        <crate::RegValueT<Fbkpgcr_SPEC> as RegisterValue<_>>::new(0)
    }
}
pub mod fbkpgcr {

    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Bkpgen_SPEC;
    pub type Bkpgen = crate::EnumBitfieldStruct<u8, Bkpgen_SPEC>;
    impl Bkpgen {
        #[doc = "Bank programming is disabled (User mode)"]
        pub const _0: Self = Self::new(0);

        #[doc = "Bank programming is enabled (Bank programming mode)"]
        pub const _1: Self = Self::new(1);
    }
}
#[doc(hidden)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct Fbkswcr_SPEC;
impl crate::sealed::RegSpec for Fbkswcr_SPEC {
    type DataType = u16;
}

#[doc = "Flash Bank Swap Control Register"]
pub type Fbkswcr = crate::RegValueT<Fbkswcr_SPEC>;
...
impl Fbkswcr {
    ...
    pub fn fekey(
        self,
    ) -> crate::common::RegisterField<8, 0xff, 1, 0, u8, u8, Fbkswcr_SPEC, crate::common::W> {
        crate::common::RegisterField::<8,0xff,1,0,u8,u8,Fbkswcr_SPEC,crate::common::W>::from_register(self,0)
    }
}
impl ::core::default::Default for Fbkswcr {
    #[inline(always)]
    fn default() -> Fbkswcr {
        <crate::RegValueT<Fbkswcr_SPEC> as RegisterValue<_>>::new(0)
    }
}
pub mod fbkswcr {

    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Bkswupen_SPEC;
    pub type Bkswupen = crate::EnumBitfieldStruct<u8, Bkswupen_SPEC>;
    impl Bkswupen {
        #[doc = "Writing FCTLFR.BANKSWP\\[2:0\\] is disabled"]
        pub const _0: Self = Self::new(0);

        #[doc = "Writing FCTLFR.BANKSWP\\[2:0\\] is enabled"]
        pub const _1: Self = Self::new(1);
    }
}
