...
impl super::Pfs {
    ...
    #[inline(always)]
    pub const fn psar(&self) -> &'static crate::common::Reg<self::Psar_SPEC, crate::common::RW> {
        unsafe {
...
pub mod prwcntr {
    ...
    impl Wait {
        ...
        #[doc = "insert wait cycle 1"]
        pub const _0_X_1: Self = Self::new(1);

        #[doc = "insert wait cycle 2"]
        pub const _0_X_2: Self = Self::new(2);

        #[doc = "insert wait cycle 3"]
        pub const _0_X_3: Self = Self::new(3);

        #[doc = "insert wait cycle 4"]
        pub const _0_X_4: Self = Self::new(4);

        #[doc = "insert wait cycle 5"]
        pub const _0_X_5: Self = Self::new(5);

        #[doc = "insert wait cycle 6"]
        pub const _0_X_6: Self = Self::new(6);

        #[doc = "insert wait cycle 7"]
        pub const _0_X_7: Self = Self::new(7);

        #[doc = "insert wait cycle 8"]
        pub const _0_X_8: Self = Self::new(8);

        #[doc = "insert wait cycle 9"]
        pub const _0_X_9: Self = Self::new(9);

        #[doc = "insert wait cycle 10"]
        pub const _0_X_A: Self = Self::new(10);

        #[doc = "insert wait cycle 11"]
        pub const _0_X_B: Self = Self::new(11);

        #[doc = "insert wait cycle 12"]
        pub const _0_X_C: Self = Self::new(12);

        #[doc = "insert wait cycle 13"]
        pub const _0_X_D: Self = Self::new(13);

        #[doc = "insert wait cycle 14"]
        pub const _0_X_E: Self = Self::new(14);

        #[doc = "insert wait cycle 15"]
...
impl Psar {
    #[doc = "PRWCNTR Security Attribution"]
    #[inline(always)]
    pub fn portsa0(
        self,
    ) -> crate::common::RegisterField<
...
pub mod psar {
    ...
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Portsa0_SPEC;
    pub type Portsa0 = crate::EnumBitfieldStruct<u8, Portsa0_SPEC>;
    impl Portsa0 {
        #[doc = "Secure"]
        pub const _0: Self = Self::new(0);
