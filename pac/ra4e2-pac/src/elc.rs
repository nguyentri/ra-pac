...
impl super::Elc {
    ...
    #[doc = "Event Link Setting Register 23"]
    #[inline(always)]
    pub const fn elsr23(
        &self,
    ) -> &'static crate::common::Reg<self::Elsr23_SPEC, crate::common::RW> {
        unsafe {
            crate::common::Reg::<self::Elsr23_SPEC, crate::common::RW>::from_ptr(
...
impl crate::sealed::RegSpec for Elsr23_SPEC {
    type DataType = u16;
}

#[doc = "Event Link Setting Register 23"]
pub type Elsr23 = crate::RegValueT<Elsr23_SPEC>;
...
impl Elsr23 {
    ...
    pub fn els(
        self,
    ) -> crate::common::RegisterField<0, 0x1ff, 1, 0, u16, u16, Elsr23_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<0,0x1ff,1,0,u16,u16,Elsr23_SPEC,crate::common::RW>::from_register(self,0)
    }
}
impl ::core::default::Default for Elsr23 {
    #[inline(always)]
    fn default() -> Elsr23 {
        <crate::RegValueT<Elsr23_SPEC> as RegisterValue<_>>::new(0)
    }
}
...
impl Elcsarc {
    #[doc = "Event Link Setting Register n Security Attribution (n = 16 to 23)"]
    #[inline(always)]
    pub fn elsr(
        self,
    ) -> crate::common::RegisterField<
