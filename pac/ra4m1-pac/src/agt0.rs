...
impl Agt {
    #[doc = "16bit counter and reload register\nNOTE : When 1 is written to the TSTOP bit in the AGTCRn register, the 16-bit counter is forcibly stopped and set to FFFFH."]
    #[inline(always)]
    pub fn agt(
        self,
...
impl Agtcma {
    #[doc = "AGT Compare Match A data is stored.\nNOTE : When 1 is written to the TSTOP bit in the AGTCRn register, set to FFFFH"]
    #[inline(always)]
    pub fn agtcma(
        self,
...
impl Agtcmb {
    #[doc = "AGT Compare Match B data is stored.\nNOTE : When 1 is written to the TSTOP bit in the AGTCR register, set to FFFFH"]
    #[inline(always)]
    pub fn agtcmb(
        self,
...
impl Agtisr {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<0, 0x3, 1, 0, u8, u8, Agtisr_SPEC, crate::common::RW> {
        crate::common::RegisterField::<0,0x3,1,0,u8,u8,Agtisr_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl Agtiosel {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<2, 0x3, 1, 0, u8, u8, Agtiosel_SPEC, crate::common::RW> {
        crate::common::RegisterField::<2,0x3,1,0,u8,u8,Agtiosel_SPEC,crate::common::RW>::from_register(self,0)
    }
