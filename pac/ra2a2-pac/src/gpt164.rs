...
#[allow(unused_imports)]
use crate::common::*;
#[doc = r"General PWM 16-bit Timer 4"]
...
pub mod gtintad {
    ...
    impl Grp {
        #[doc = "Group A output disable source is selected Group B output disable source is selected Setting prohibited"]
        pub const _00: Self = Self::new(0);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
...
pub mod gtst {
    ...
    impl Oabhf {
        #[doc = "No simultaneous generation of 1 both for the GTIOCnA and GTIOCnB pins has occurred."]
        pub const _0: Self = Self::new(0);

        #[doc = "A simultaneous generation of 1 both for the GTIOCnA and GTIOCnB pins has occurred."]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Oablf {
        #[doc = "No simultaneous generation of 0 both for the GTIOCnA and GTIOCnB pins has occurred."]
        pub const _0: Self = Self::new(0);

        #[doc = "A simultaneous generation of 0 both for the GTIOCnA and GTIOCnB pins has occurred."]
        pub const _1: Self = Self::new(1);
    }
}
#[doc(hidden)]
