...
impl super::I3CNs {
    ...
    #[doc = "Clock Enable Control Resister"]
    #[inline(always)]
...
pub mod ibinctl {
    ...
    impl Nrmrctl {
        ...
        #[doc = "Pass rejected IBI Status to the Normal IBI Queue if the incoming Master Request is NACKed and is auto-disabled based on DVMRRJ field in relevant DAT entry."]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
