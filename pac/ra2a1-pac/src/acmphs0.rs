...
impl Cmpctl {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterFieldBool<2, 1, 0, Cmpctl_SPEC, crate::common::RW> {
        crate::common::RegisterFieldBool::<2, 1, 0, Cmpctl_SPEC, crate::common::RW>::from_register(
            self, 0,
        )
    }
...
pub mod cmpsel1 {
    ...
    impl Crvs {
        ...
        #[doc = "IVREF4 selected"]
        pub const _010000: Self = Self::new(16);

        #[doc = "IVREF5 selected"]
        pub const _100000: Self = Self::new(32);
