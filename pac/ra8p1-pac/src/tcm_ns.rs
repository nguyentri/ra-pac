...
use crate::common::*;
#[doc = r"TCM_NS"]
unsafe impl ::core::marker::Send for super::TcmNs {}
unsafe impl ::core::marker::Sync for super::TcmNs {}
impl super::TcmNs {
    #[allow(unused)]
    #[inline(always)]
    ...
    #[doc = "TCM Protection Control Register for Non-Secure"]
    #[inline(always)]
    pub const fn tcmprcr_ns(
        &self,
    ) -> &'static crate::common::Reg<self::TcmprcrNs_SPEC, crate::common::RW> {
        unsafe {
            crate::common::Reg::<self::TcmprcrNs_SPEC, crate::common::RW>::from_ptr(
...
pub struct TcmprcrNs_SPEC;
impl crate::sealed::RegSpec for TcmprcrNs_SPEC {
    type DataType = u16;
}

#[doc = "TCM Protection Control Register for Non-Secure"]
pub type TcmprcrNs = crate::RegValueT<TcmprcrNs_SPEC>;
...
impl TcmprcrNs {
    ...
    pub fn kw(
        self,
    ) -> crate::common::RegisterField<8, 0xff, 1, 0, u8, u8, TcmprcrNs_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<8,0xff,1,0,u8,u8,TcmprcrNs_SPEC,crate::common::RW>::from_register(self,0)
    }
}
impl ::core::default::Default for TcmprcrNs {
    #[inline(always)]
    fn default() -> TcmprcrNs {
        <crate::RegValueT<TcmprcrNs_SPEC> as RegisterValue<_>>::new(0)
    }
}
pub mod tcmprcr_ns {
