...
pub mod ulptmr3 {
    ...
    impl Topol {
        #[doc = "Start the ULPTOn output when in low level"]
        pub const _0: Self = Self::new(0);

        #[doc = "Start the ULPTOn output when in high level"]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
...
pub mod ulptisr {
    ...
    impl Rccpsel2 {
        #[doc = "Count external events when low"]
        pub const _0: Self = Self::new(0);

        #[doc = "Count external events when high"]
        pub const _1: Self = Self::new(1);
    }
}
#[doc(hidden)]
...
pub mod ulptcmsr {
    ...
    impl Topola {
        #[doc = "Start the ULPTOAn output when low"]
        pub const _0: Self = Self::new(0);

        #[doc = "Start the ULPTOAn output when high"]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    ...
    impl Topolb {
        #[doc = "Start the ULPTOBn output when low"]
        pub const _0: Self = Self::new(0);

        #[doc = "Start the ULPTOBn output when high"]
        pub const _1: Self = Self::new(1);
    }
}
