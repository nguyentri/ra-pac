...
impl Spscr {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<3, 0x1f, 1, 0, u8, u8, Spscr_SPEC, crate::common::RW> {
        crate::common::RegisterField::<3,0x1f,1,0,u8,u8,Spscr_SPEC,crate::common::RW>::from_register(self,0)
    }
...
impl Spssr {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterFieldBool<3, 1, 0, Spssr_SPEC, crate::common::R> {
        crate::common::RegisterFieldBool::<3, 1, 0, Spssr_SPEC, crate::common::R>::from_register(
            self, 0,
        )
    }
...
impl Spdcr {
    ...
    pub fn reserved(
        self,
    ) -> crate::common::RegisterField<2, 0x3, 1, 0, u8, u8, Spdcr_SPEC, crate::common::RW> {
        crate::common::RegisterField::<2,0x3,1,0,u8,u8,Spdcr_SPEC,crate::common::RW>::from_register(self,0)
    }
...
pub mod spcmd {
    ...
    impl Sslkp {
        #[doc = "Negates all SSL signals upon completion of transfer"]
        pub const _0: Self = Self::new(0);

        #[doc = "Keeps the SSL signal level from the end of transfer until the beginning of the next access"]
        pub const _1: Self = Self::new(1);
    }
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
