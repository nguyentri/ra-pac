...
impl super::RmpuNs {
    ...
    #[doc = "MMPU Regions Protect Register for DMAC Non-secure %s"]
    #[inline(always)]
    pub const fn mmpurptdmac(
        &self,
    ) -> &'static crate::common::ClusterRegisterArray<
        crate::common::Reg<self::Mmpurptdmac_SPEC, crate::common::RW>,
        2,
        0x200,
    > {
        unsafe {
