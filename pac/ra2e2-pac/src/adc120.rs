...
impl super::Adc120 {
    ...
    > {
        unsafe {
            crate::common::ClusterRegisterArray::from_ptr(self._svd2pac_as_ptr().add(0xe9usize))
        }
    }
    #[inline(always)]
...
pub mod adhvrefcnt {
    ...
    impl Hvsel {
        #[doc = "VCC0 is selected as the high-potential reference voltage"]
        pub const _00: Self = Self::new(0);
    ...
    impl Lvsel {
        #[doc = "VSS0 is selected as the low-potential reference voltage."]
        pub const _0: Self = Self::new(0);
