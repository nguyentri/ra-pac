...
use crate::common::*;
#[doc = r""]
unsafe impl ::core::marker::Send for super::MipiPhy0Ns {}
unsafe impl ::core::marker::Sync for super::MipiPhy0Ns {}
impl super::MipiPhy0Ns {
    #[allow(unused)]
    #[inline(always)]
...
impl Dphyplfcr {
    ...
    pub fn nmul(
        self,
    ) -> crate::common::RegisterField<16, 0xff, 1, 0, u8, u8, Dphyplfcr_SPEC, crate::common::RW>
    {
        crate::common::RegisterField::<16,0xff,1,0,u8,u8,Dphyplfcr_SPEC,crate::common::RW>::from_register(self,0)
    }
}
...
impl ::core::default::Default for Dphytim2 {
    #[inline(always)]
    fn default() -> Dphytim2 {
        <crate::RegValueT<Dphytim2_SPEC> as RegisterValue<_>>::new(135176)
    }
}
...
impl ::core::default::Default for Dphytim3 {
    #[inline(always)]
    fn default() -> Dphytim3 {
        <crate::RegValueT<Dphytim3_SPEC> as RegisterValue<_>>::new(4104)
    }
}
