...
impl super::Rtc {
    ...
    pub const fn bcnt0ar(
        ...
        crate::common::Reg<self::Bcnt0Ar_SPEC, crate::common::RW>,
        2,
        0x20,
    > {
        unsafe {
    ...
    pub const fn rsecar(
        ...
        crate::common::Reg<self::Rsecar_SPEC, crate::common::RW>,
        2,
        0x20,
    > {
        unsafe {
    ...
    pub const fn bcnt1ar(
        ...
        crate::common::Reg<self::Bcnt1Ar_SPEC, crate::common::RW>,
        2,
        0x20,
    > {
        unsafe {
    ...
    pub const fn rminar(
        ...
        crate::common::Reg<self::Rminar_SPEC, crate::common::RW>,
        2,
        0x20,
    > {
        unsafe {
    ...
    pub const fn bcnt2ar(
        ...
        crate::common::Reg<self::Bcnt2Ar_SPEC, crate::common::RW>,
        2,
        0x20,
    > {
        unsafe {
    ...
    pub const fn rhrar(
        ...
        crate::common::Reg<self::Rhrar_SPEC, crate::common::RW>,
        2,
        0x20,
    > {
        unsafe {
    ...
    #[inline(always)]
    pub const fn rhrar0(&self) -> &'static crate::common::Reg<self::Rhrar_SPEC, crate::common::RW> {
        unsafe {
    ...
    #[inline(always)]
    pub const fn rhrar1(&self) -> &'static crate::common::Reg<self::Rhrar_SPEC, crate::common::RW> {
        unsafe {
            crate::common::Reg::<self::Rhrar_SPEC, crate::common::RW>::from_ptr(
                self._svd2pac_as_ptr().add(0x34usize),
            )
    ...
    pub const fn bcnt3ar(
        ...
        crate::common::Reg<self::Bcnt3Ar_SPEC, crate::common::RW>,
        2,
        0x20,
    > {
        unsafe {
            crate::common::ClusterRegisterArray::from_ptr(self._svd2pac_as_ptr().add(0x16usize))
        }
    }
    #[inline(always)]
    pub const fn bcnt3ar0(
        &self,
    ...
    pub const fn rwkar(
        ...
        crate::common::Reg<self::Rwkar_SPEC, crate::common::RW>,
        2,
        0x20,
    > {
        unsafe {
    ...
    #[inline(always)]
    pub const fn rwkar0(&self) -> &'static crate::common::Reg<self::Rwkar_SPEC, crate::common::RW> {
        unsafe {
    ...
    #[inline(always)]
    pub const fn rwkar1(&self) -> &'static crate::common::Reg<self::Rwkar_SPEC, crate::common::RW> {
        unsafe {
            crate::common::Reg::<self::Rwkar_SPEC, crate::common::RW>::from_ptr(
                self._svd2pac_as_ptr().add(0x36usize),
            )
    ...
    pub const fn bcnt0aer(
        ...
        crate::common::Reg<self::Bcnt0Aer_SPEC, crate::common::RW>,
        2,
        0x20,
    > {
        unsafe {
    ...
    pub const fn rdayar(
        ...
        crate::common::Reg<self::Rdayar_SPEC, crate::common::RW>,
        2,
        0x20,
    > {
        unsafe {
    ...
    pub const fn bcnt1aer(
        ...
        crate::common::Reg<self::Bcnt1Aer_SPEC, crate::common::RW>,
        2,
        0x20,
    > {
        unsafe {
    ...
    pub const fn rmonar(
        ...
        crate::common::Reg<self::Rmonar_SPEC, crate::common::RW>,
        2,
        0x20,
    > {
        unsafe {
    ...
    pub const fn bcnt2aer(
        ...
        crate::common::Reg<self::Bcnt2Aer_SPEC, crate::common::RW>,
        2,
        0x20,
    > {
        unsafe {
            crate::common::ClusterRegisterArray::from_ptr(self._svd2pac_as_ptr().add(0x1cusize))
        }
    }
    #[inline(always)]
    pub const fn bcnt2aer0(
        &self,
    ...
    pub const fn ryrar(
        ...
        crate::common::Reg<self::Ryrar_SPEC, crate::common::RW>,
        2,
        0x20,
    > {
        unsafe {
    ...
    #[inline(always)]
    pub const fn ryrar0(&self) -> &'static crate::common::Reg<self::Ryrar_SPEC, crate::common::RW> {
        unsafe {
    ...
    #[inline(always)]
    pub const fn ryrar1(&self) -> &'static crate::common::Reg<self::Ryrar_SPEC, crate::common::RW> {
        unsafe {
            crate::common::Reg::<self::Ryrar_SPEC, crate::common::RW>::from_ptr(
                self._svd2pac_as_ptr().add(0x3cusize),
            )
    ...
    pub const fn bcnt3aer(
        ...
        crate::common::Reg<self::Bcnt3Aer_SPEC, crate::common::RW>,
        2,
        0x20,
    > {
        unsafe {
            crate::common::ClusterRegisterArray::from_ptr(self._svd2pac_as_ptr().add(0x1eusize))
        }
    }
    #[inline(always)]
    pub const fn bcnt3aer0(
        &self,
    ...
    pub const fn ryraren(
        ...
        crate::common::Reg<self::Ryraren_SPEC, crate::common::RW>,
        2,
        0x20,
    > {
        unsafe {
...
pub mod rcr4 {
    ...
    #[derive(Clone, Copy, Eq, PartialEq, Ord, PartialOrd)]
    pub struct Adj500M_SPEC;
    pub type Adj500M = crate::EnumBitfieldStruct<u8, Adj500M_SPEC>;
    impl Adj500M {
        #[doc = "In writing: Invalid (writing 0 has no effect) In reading: Normal time operation in progress, or 0.5-second adjustment has completed"]
        pub const _0: Self = Self::new(0);

        #[doc = "In writing: Execute 0.5-second adjustment In reading: 0.5-second adjustment in progress"]
        pub const _1: Self = Self::new(1);
    }
}
#[doc(hidden)]
...
pub mod rtccr {
    ...
    impl Tcnf {
        ...
        #[doc = "Turn noise filter on (count source by divided by 4096)"]
        pub const _100: Self = Self::new(4);
