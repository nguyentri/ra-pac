...
#[allow(unused_imports)]
use crate::common::*;
#[doc = r"General PWM Timer Clock Controller"]
unsafe impl ::core::marker::Send for super::GptGtclkNs {}
unsafe impl ::core::marker::Sync for super::GptGtclkNs {}
impl super::GptGtclkNs {
    #[allow(unused)]
    #[inline(always)]
